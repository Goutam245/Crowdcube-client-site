...
<footer className="footer bg-gray-800 text-white p-10">
  <nav>
    <h6 className="footer-title text-2xl"><span className='text-white'>Crowd</span> <span className='text-blue-400'>Cube</span></h6>
...
<form
  className="text-neutral-800 py-6 relative overflow-hidden flex flex-col justify-around w- h- border border-neutral-500 rounded-lg bg-neutral-50 p-3 px-6"
>
  <div
